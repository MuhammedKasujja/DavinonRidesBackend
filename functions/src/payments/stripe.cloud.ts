...
export const getCustomer = functions.https.onRequest((req, res) => {
...
export const createPaymentMethod = functions.https.onRequest((req, res) => {
...
const createSubscriptionCF = function(req: any, res: any, customerId: String, quantity: Number) {
...
export const createCustomerAndSubscription = functions.https.onRequest((req, res) => {
	return cors(req, res, () => {
		...
		stripe.customers.create({
			...
			function (err: any, customer: any) {
				if (customer) {
					return createSubscriptionCF(req, res, customer.id, data.quantity);
				} else {
					res.status(err.statusCode).send(err.message);
					reportError(err);
				}
...
export const createSubscription = functions.https.onRequest((req, res) => {
	...
	return cors(req, res, () => {
		...
		return createSubscriptionCF(req, res, data.customerId, data.quantity);
...
export const attachPaymentToCustomer = functions.https.onRequest((req, res) => {
